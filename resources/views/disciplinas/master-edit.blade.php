@extends('layouts.app')
@section('breadcrumb')
@breadcrumbs(['title'=>'Disciplinas', 'icon'=>'fa-book', 'route'=>route('modules.index'),'subtitle'=>'Gerenciamento de Disciplinas'])
...
<a class="btn btn-sm btn-outline-secondary mr-1 mb-1"  href="{{route('disciplinas.index')}}" > <i class="fa fa-close"></i>Cancelar</a>
