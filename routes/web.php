...
Route::group(['middleware' => ['auth','adm']], function () {    
    ...
    Route::post('/messages/send_bath', '\App\Http\Controllers\MessageController@sendBath')->name('messages_bath.send');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('getPivotsByStudentAndAula','\App\Http\Controllers\GradeController@getPivotsByStudentAndAula');
